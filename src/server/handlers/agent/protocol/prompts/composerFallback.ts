/**
 * Composer 回退 system prompt
 *
 * 当 promptProfile.systemPromptStyle === 'composer-fallback' 时使用,
 * 多见于没有原生 thinking 能力的轻量模型。
 */
export function buildComposerFallbackSystemPrompt(): string {
